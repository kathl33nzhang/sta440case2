...
1.  Genotype appears significantly correlated with $VO_2$ production: transgenic mice had higher $VO_2$ than natural mice across most conditions
2.  Substrate and dose seem to matter as well: We saw certain substrates had a larger effect in the $VO_2$ production as $PMOc$ and $PMPc$ tended to affect the transgenic mice more while $OcM$ and $PcM$ tended to have an equal effect on transgenic and natural mice. This relationship was highly dependent on dose.
3.  While researchers do not need to know the specific measurement predictions for each pair, we need to account for variation on the pair level in our model.
4.  Treating substrates as bundled conditions seems to capture variation in $VO_2$ more effectively.
...
$$
Our\ model:\ VO_2 = Genotype * Dose * Substrate + (1|pair) + \epsilon
$$
